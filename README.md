...
This project demonstrates how to configure and use an AWS VPC Gateway Endpoint to securely access Amazon S3 from an EC2 instance deployed in a private subnet, without requiring a NAT Gateway, Internet Gateway, or any public internet connectivity.
